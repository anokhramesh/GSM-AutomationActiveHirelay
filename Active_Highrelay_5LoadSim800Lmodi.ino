...
if(GSM_Msg=="Sok1on") {load1=1; sendSMS(GSM_Nr,"Ok Socket 1 is On");}
if(GSM_Msg=="Sok1off"){load1=0; sendSMS(GSM_Nr,"Ok Socket1 is Off");}

if(GSM_Msg=="Sok2on") {load2=1; sendSMS(GSM_Nr,"Ok Socket 2 is On");}
if(GSM_Msg=="Sok2off"){load2=0; sendSMS(GSM_Nr,"Ok Socket 2 is Off");}

if(GSM_Msg=="Sok3on") {load3=1; sendSMS(GSM_Nr,"Ok Socket 3 is On");}
if(GSM_Msg=="Sok3off"){load3=0; sendSMS(GSM_Nr,"Ok Socket 3 is Off");}

if(GSM_Msg=="Sok4on") {load4=1; sendSMS(GSM_Nr,"Ok Socket 4 is On");}
if(GSM_Msg=="Sok4off"){load4=0; sendSMS(GSM_Nr,"Ok Socket 4 is Off");}

if(GSM_Msg=="Sok5on") {load5=1; sendSMS(GSM_Nr,"Ok Socket 5 is On");}
if(GSM_Msg=="Sok5off"){load5=0; sendSMS(GSM_Nr,"Ok Socket 5 is Off");}
...
if(GSM_Msg=="Socketstatus"){
String loadst = "";

if(load1==1){loadst="Load1 On\r\n";}
        else{loadst="Load1 Off\r\n";}
        
if(load2==1){loadst=loadst + "Load2 On\r\n";}
        else{loadst=loadst + "Load2 Off\r\n";}
        
if(load3==1){loadst=loadst + "Load3 On\r\n";}
        else{loadst=loadst + "Load3 Off\r\n";}
        
if(load4==1){loadst=loadst + "Load4 On";}
        else{loadst=loadst + "Load4 Off";}
        
if(load5==1){loadst=loadst + "Load5 On";}
        else{loadst=loadst + "Load5 Off";}
